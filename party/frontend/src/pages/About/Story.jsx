  ...
  return (
    <section className="mx-auto max-w-xl py-6 lg:py-16">
      ...
      <div className="absolute -left-20 -top-20">
        <div className="relative bottom-0 z-0 h-[400px] w-[400px] animate-[bounce_15s_linear_infinite] rounded-[50%] bg-gradient-to-b from-[#E8C483]/[0.54] to-[#E25D67]/[0.68] opacity-[0.75] blur-[3px]" />
      </div>
      {/* blur */}
